...
export default function RecentAnnouncement () {
  const announcements = [
    ...
    { id: 3, title: "The submission date of the assignment is exte...", date: "Nov 18, 2024" },
    { id: 4, title: "The submission date of the assignment is exte...", date: "Nov 18, 2024" },
  ];

  return (
    <div className="p-4 col-span-6 h-auto lg:h-60 rounded-xl shadow-md bg-gradient-to-r from-green-500 to-green-400 text-white">
      ...
      <button
        onClick={() => window.location.href = '/employer/announcements'}
